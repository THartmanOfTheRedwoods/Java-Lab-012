...
1. Nouns: Solar system, planet, sun, coordinate, mass, size, distance, velocity
2. Adjectives: solar, central, celestial, orbiting, coordinate, massive, relative, simulated
3. Verbs: create, move, show, set 
