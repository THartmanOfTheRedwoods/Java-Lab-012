...
* Nouns: solar-system, simulation, planets, sun, mass, size, gravity, coordinate, position, period, distance, velocity
* Adjectives: solar, each, coordinate, mass, size
* Verbs: create, add, move, show, located, know, set, get
