...
Nouns: solar-system, simulation, planets, sun, simulation, planets, mass, size, gravity, simulation, planet, period, Sun, center, solar-system, coordinate, Planet, coordinate, position, mass, size, point, distance, sun, simulation, planet, position, velocity
Adjectives: solar, each, given,
Verbs: want, create, add, should, move, should, show, should, want, know, is, move, get, set
